...
export const {useGetProductsQuery, useGetProductQuery, useGetCategoriesQuery, usePostOrdersMutation, usePutProfileImageMutation, useGetProfileImageQuery, usePutUserLocationMutation, useGetUserLocationQuery} = shopApi
